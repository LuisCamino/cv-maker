...
<div class="container">
    ...
    <div class="row justify-content-left"><a class="ml-4 mt-3" href="{{route('home')}}"><img src="https://i.postimg.cc/DZ3rC19N/back-button.png"style="width:30px;height:30px;"></a></div>
</div>
@endsection
