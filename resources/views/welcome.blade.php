        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" class="text-sm text-black-700 underline"><h2 class="h2">Home</h2></a>
                    @else
                        <a href="{{ route('login') }}" class="text-lg text-black-700 underline">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-lg text-black-700 underline">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
               ...
               <h1 class="h1">Resume Creator</h1>
                ...
                <div class="ml-5">
                    <div class="mt-2 text-black-800 dark:text-gray-400 text-md">
                        Resume Creator is a minimalist tool that allows you to create your own resumes, it's simple to use and recommended for the people who is starting to create his first resumes, or just for people who wants a simple but good-looking resume.   
                    </div>
                </div>
            </div>
        </div>
